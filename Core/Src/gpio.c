...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LED0_Pin|OV_SDA_Pin|OV_SCL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : OV_SDA_Pin OV_SCL_Pin */
  GPIO_InitStruct.Pin = OV_SDA_Pin|OV_SCL_Pin;
